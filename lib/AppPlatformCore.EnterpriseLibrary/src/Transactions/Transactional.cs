...
namespace AppPlatform.Core.EnterpriseLibrary.Transactions
{
    public class Transactional<T> : ISinglePhaseNotification
    {
        ...
        public static bool operator ==(Transactional<T> t1, Transactional<T> t2)
        {
            ...
            bool t1Null = (System.Object.ReferenceEquals(t1, null) || t1.Value == null);
            bool t2Null = (System.Object.ReferenceEquals(t2, null) || t2.Value == null);
        ...
        protected virtual T Clone(T t)
        {
            return ResouceManager.Clone(t);
        }
    }
}